...
export default function OverviewScreen(props: WebScreenProps) {
  ...
  return (
    <div className="relative overflow-x-hidden min-h-screen pb-20">
      ...
      <div className="absolute top-40 left-10 w-[500px] h-[500px] bg-blue-200/20 rounded-full blur-[100px] pointer-events-none -z-10 animate-pulse duration-[10s]"></div>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6">
          <div className="w-full xl:w-auto">
            ...
            <h1 className="text-4xl md:text-5xl xl:text-6xl font-outfit font-black text-blue-950 tracking-tight leading-tight">
              Selamat datang,<br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-500 to-cyan-500">JagoAI Global.</span>
            </h1>
          </div>
          <div className="flex flex-col sm:flex-row gap-4 w-full xl:w-auto">
            <button className="h-14 px-8 flex-1 sm:flex-none rounded-full bg-white text-slate-700 font-bold hover:bg-slate-50 transition-all shadow-[0_8px_20px_rgba(0,0,0,0.04)] hover:shadow-[0_15px_30px_rgba(0,0,0,0.08)] hover:-translate-y-1 flex items-center justify-center gap-2 border border-slate-100">
              <Activity className="w-5 h-5 text-blue-600 shrink-0" /> Monitor
            </button>
            <button className="h-14 px-8 flex-1 sm:flex-none rounded-full bg-blue-950 text-white font-bold hover:bg-slate-800 transition-all shadow-[0_8px_20px_rgba(15,23,42,0.2)] hover:shadow-[0_15px_30px_rgba(15,23,42,0.3)] hover:-translate-y-1">
              Unduh Laporan
            </button>
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          <div className="relative overflow-hidden bg-blue-950 text-white rounded-[2.5rem] p-8 shadow-[0_20px_50px_rgba(15,23,42,0.2)] group hover:-translate-y-1 transition-all duration-500">
            <div className="absolute -top-20 -right-20 w-64 h-64 bg-gradient-to-br from-blue-600/40 to-cyan-500/0 rounded-full blur-[50px] group-hover:scale-125 transition-transform duration-1000"></div>
            ...
            <div className="flex justify-between items-start relative z-10 mb-8">
              <div className="w-14 h-14 bg-white/10 backdrop-blur-xl rounded-[1.2rem] flex items-center justify-center border border-white/10 group-hover:rotate-6 transition-transform">
                <DollarSign className="w-7 h-7 text-blue-400" strokeWidth="2.5" />
              </div>
          ...
          <div className="relative overflow-hidden premium-glass rounded-[2.5rem] p-8 group hover:-translate-y-1 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(52,211,153,0.15)] cursor-pointer">
            ...
            <div className="relative z-10">
              ...
              <div className="font-space font-bold text-3xl lg:text-4xl mt-2 tracking-tight text-blue-950 truncate flex items-baseline gap-1">
          ...
          <div className="relative overflow-hidden premium-glass rounded-[2.5rem] p-8 group hover:-translate-y-1 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(99,102,241,0.15)] cursor-pointer">
            <div className="absolute -top-20 -right-20 w-64 h-64 bg-blue-400/20 rounded-full blur-[50px] group-hover:scale-125 transition-transform duration-1000"></div>
            
            <div className="flex justify-between items-start relative z-10 mb-8">
              <div className="w-14 h-14 bg-white rounded-[1.2rem] flex items-center justify-center border border-blue-100 shadow-sm group-hover:rotate-6 transition-transform">
                <Eye className="w-7 h-7 text-blue-600" strokeWidth="2.5" />
              </div>
              <span className="bg-blue-50 px-4 py-1.5 rounded-full text-xs font-bold text-blue-700 tracking-widest uppercase font-outfit border border-blue-100">Sistem</span>
            </div>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 premium-glass rounded-[3rem] p-8 md:p-10 flex flex-col group overflow-hidden">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
              <div>
                <h3 className="text-2xl md:text-3xl font-outfit font-black text-blue-950 tracking-tight">Arus Kas 6 Bulan</h3>
              ...
              <div className="flex items-center gap-4 bg-white/80 backdrop-blur-md px-5 py-3 rounded-full border border-slate-100 shadow-sm">
                <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-slate-600 font-outfit">
                  <div className="w-3 h-3 rounded-full bg-blue-600"></div> Pemasukan
                </div>
                <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-slate-600 font-outfit">
          ...
          <div className="premium-glass rounded-[3rem] p-8 md:p-10 flex flex-col justify-between items-center group overflow-hidden">
            <div className="w-full text-center">
              <h3 className="text-2xl font-outfit font-black text-blue-950 tracking-tight">Alokasi Biaya</h3>
            ...
            <div className="relative w-56 h-56 my-8 shrink-0 drop-shadow-2xl">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <span className="font-space font-bold text-blue-950 text-xl truncate max-w-[90px]">
              ...
              {categoryEntries.slice(0, 3).map(([cat, val], idx) => {
                ...
                return (
                  <div key={cat} className="flex justify-between items-center bg-white/60 p-3 rounded-2xl border border-white shadow-sm hover:scale-[1.02] transition-transform">
                    ...
                    <span className="text-sm font-space font-bold text-blue-950 ml-2 shrink-0">{(val/1000000).toFixed(1)}M</span>
                  </div>
                );
              })}
            </div>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="premium-glass rounded-[3rem] p-8 md:p-10 overflow-hidden">
            <div className="flex justify-between items-center mb-8">
              <div>
                <h3 className="text-2xl font-outfit font-black text-blue-950 tracking-tight">Antrian Verifikasi</h3>
                ...
                pendingApprovals.slice(0, 4).map((tx, i) => (
                  ...
                  >
                    <div className="flex items-center gap-4 w-full sm:w-auto overflow-hidden">
                      <div className="w-12 h-12 rounded-[1.2rem] bg-blue-50 border border-blue-100 text-blue-700 font-outfit font-black flex items-center justify-center text-sm shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                        {(employees.find(e => e.id === tx.employeeId)?.name || "U")[0]}
                      </div>
                      <div className="overflow-hidden">
                        <span className="font-bold text-base text-blue-950 block truncate">{employees.find(e => e.id === tx.employeeId)?.name || "Unknown"}</span>
                        <span className="text-xs text-slate-500 font-medium mt-1 block truncate">{tx.category} • {tx.merchant}</span>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 w-full sm:w-auto justify-between sm:justify-end">
                      <span className="font-space font-bold text-blue-950 text-base shrink-0">Rp {tx.amount.toLocaleString('id-ID')}</span>
                      <div className="w-10 h-10 flex items-center justify-center rounded-full bg-blue-950 text-white group-hover:bg-blue-600 transition-colors shrink-0">
          ...
          <div className="premium-glass rounded-[3rem] p-8 md:p-10 overflow-hidden">
            <div className="flex justify-between items-center mb-8">
              <div>
                <h3 className="text-2xl font-outfit font-black text-blue-950 tracking-tight">Performa Integrasi</h3>
                <p className="text-slate-500 text-sm mt-1">Top revenue bulan ini</p>
              </div>
              <button className="text-sm font-bold text-blue-700 hover:text-indigo-800 transition-colors shrink-0 bg-blue-50 px-4 py-2 rounded-full">Lihat Semua</button>
            </div>
              ...
              {topApps.slice(0, 4).map((app, idx) => (
                ...
                >
                  <div className="flex items-center gap-4 w-full sm:w-auto overflow-hidden">
                    ...
                    <div className="overflow-hidden">
                      <h6 className="font-bold text-base text-blue-950 truncate">{app.name}</h6>
                  ...
                  <span className="font-space font-bold text-base text-blue-950 shrink-0 self-end sm:self-auto bg-slate-50 px-4 py-2 rounded-full border border-slate-100">
