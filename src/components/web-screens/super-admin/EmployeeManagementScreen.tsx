    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col md:flex-row justify-between md:items-center gap-6 bg-white/70 backdrop-blur-xl p-8 rounded-[3rem] border border-white shadow-xl shadow-slate-200/40">
        <div className="flex items-center gap-6">
          ...
          <div>
            <h2 className="text-3xl lg:text-4xl font-black font-display text-blue-950 tracking-tight">Kelola Karyawan</h2>
        ...
        <button 
          ...
          className="px-6 py-4 bg-blue-950 hover:bg-slate-800 text-white font-black rounded-[1.5rem] shadow-xl shadow-slate-200 transition-all active:scale-95 flex items-center justify-center gap-2 hover:-translate-y-0.5"
        >
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8 mt-2 p-2">
          <div className="flex-1 relative group">
            ...
            <input 
              ...
              className="w-full pl-14 pr-6 py-4 bg-slate-50 border border-slate-200 rounded-[1.5rem] text-[15px] font-semibold outline-none focus:border-blue-500 focus:bg-white transition-all shadow-inner placeholder:text-slate-400"
            />
          </div>
          {userRole === 'super_admin' && (
            <div className="w-full md:w-72 relative">
              ...
              <select 
                ...
                className="w-full pl-12 pr-12 py-4 bg-slate-50 border border-slate-200 rounded-[1.5rem] text-[15px] font-bold outline-none focus:border-blue-500 focus:bg-white transition-all shadow-inner appearance-none text-slate-700 relative z-0 cursor-pointer"
              >
                  ...
                  <tr key={emp.id} className="bg-white hover:bg-slate-50 transition-all shadow-sm hover:shadow-xl hover:shadow-indigo-900/5 border border-slate-100 group rounded-[2rem] overflow-hidden">
                    <td className="p-5 pl-6 rounded-l-[2rem]">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-[1.25rem] bg-gradient-to-br from-blue-100 to-brand/10 text-brand flex items-center justify-center font-black text-lg shadow-sm border border-brand/10 group-hover:bg-brand group-hover:text-white transition-colors duration-500 shrink-0">
                    ...
                    <td className="p-5 rounded-r-[2rem] pr-6 text-right">
                      <button 
                        ...
                        className="p-2.5 bg-slate-100 text-slate-600 hover:bg-blue-700 hover:text-white rounded-xl transition-all shadow-sm"
                        title="Lihat Detail"
                      >
          ...
          <div className="bg-white w-full max-w-md max-h-[90vh] flex flex-col rounded-[2rem] shadow-2xl overflow-hidden relative">
            ...
            <div className="p-6 md:p-8 space-y-6 relative z-10 overflow-y-auto custom-scrollbar flex-1">
              <div className="flex flex-col items-center mb-4">
                ...
                <h4 className="text-2xl font-black text-blue-950 tracking-tight">{selectedEmployee.name}</h4>
          ...
          <div className="bg-white w-full max-w-md max-h-[90vh] flex flex-col rounded-[2.5rem] shadow-2xl overflow-hidden relative">
            ...
            <div className="p-6 md:p-8 border-b border-slate-100 flex justify-between items-center relative z-10 shrink-0">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-black text-xl text-blue-950 font-display tracking-tight">Undang Karyawan</h3>
            ...
            <div className="p-6 md:p-8 relative z-10 overflow-y-auto custom-scrollbar flex-1">
              ...
              >
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full pl-12 pr-5 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-semibold outline-none focus:border-blue-500 focus:bg-white transition-all shadow-inner"
                      required
                    />
                  </div>
                ...
                <button 
                  ...
                  className="w-full px-6 py-4 bg-blue-950 hover:bg-slate-800 disabled:opacity-50 text-white font-black rounded-2xl shadow-xl shadow-slate-200 transition-all flex items-center justify-center gap-2"
                >
